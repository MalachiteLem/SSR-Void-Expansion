...
NK - For the original Starstorm mod

Beebo - Original sprite of Seraph in ssrcord, which is used for every Seraph's sprite within this mod

TRYAGAIN, Azuline, Kris, Onyx, Klehrik, Miguelitto, syntaxEvasion - Coding help

TangoKnight, Winslow, Beebo, DigBug, syntaxEvasion - Inspired & Learned spriting from their works

Fox, Goobessa, qwp, Wertus, Nilzer, xorgee and quite a lot of others - supportive and kind words during the development

SSR Team - Creating the remaster of Starstorm mod in Risk of Rain Returns
